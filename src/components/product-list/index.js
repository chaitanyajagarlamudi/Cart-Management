                        ...
                        <section className="w-30"
                            ...
                            <div className="card ma-16">
                                ...
                                <div className="card-actions justify-content-center pa-4">
                                  { !product.cartQuantity && <button className="x-small outlined" data-testid="btn-item-add" onClick={()=>this.props.addToCart(i)}>
                                        Add To Cart
                                    </button>}

                                    { product.cartQuantity &&  <button className="x-small danger" data-testid="btn-item-remove">
                                        Remove
                                    </button>}
                                </div>
                            </div>
